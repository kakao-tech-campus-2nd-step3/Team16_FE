...
export const NonPreferenceSection: React.FC = () => {
  ...
  const addFoodPreference = useAddFoodPreference({ type: 'disliked' });
  const deleteFoodPreference = useDeleteFoodPreference('disliked');
    ...
    <PageContainer>
      <ContentContainer>
        <SectionContainer>
          ...
          <MenuCategory foods={[...(nonPreferredFoods || []), ...selectedFoods]}>
            {(food) => (
...
export default NonPreferenceSection;
